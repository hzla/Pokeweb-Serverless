# PWAN summary sprites

Status: **source-copied**.

Bundled artifacts: `PokewebPwanSummaryB2.dll`, `PokewebPwanSummaryW2.dll`.
...
- `White2Upgrade-Original-pokeweb: src/pwan_animation/w2u_summary_anim.cpp`
- `White2Upgrade-Original-pokeweb: src/pwan_animation/w2u_summary_hooks.s`
- `White2Upgrade-Original-pokeweb: src/pwan_animation/b2_summary_hooks.s`
