...
type Endpoint = "attacker" | "defender" | "attackerSide" | "defenderSide";
...
const POSITION_MODE: Record<number, { mode: number; endpoint: Endpoint }> = {
...
function clientForEndpoint(endpoint: Endpoint, clients: { attacker: ClientType; defender: ClientType; attackerSide: ClientType; defenderSide: ClientType }): ClientType {
