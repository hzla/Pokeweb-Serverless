export const MUSIC_REFERENCE_CATEGORIES = {
  ...
  travel: "Travel",
  trainerApproaches: "Trainer approaches",
  battles: "Battles",
...
export const BW2_MUSIC_REFERENCE: readonly MusicReferenceDefinition[] = [
  ...
  entry("trainerApproaches", "Eye 01 — Youngster / default", "Common trainer-notice cue used by Youngsters, male School Kids and male Pokémon Breeders, as well as many special or fallback trainer classes. It plays before the battle theme begins.", track("EYE_01")),
  entry("trainerApproaches", "Eye 02 — Lass / female School Kid", "Trainer-notice cue used by Lasses, female School Kids and Ladies. It plays before the battle theme begins.", track("EYE_02")),
  entry("trainerApproaches", "Eye 03 — Preschooler / Twins", "Trainer-notice cue used by Preschoolers and Twins. It plays before the battle theme begins.", track("EYE_03")),
  entry("trainerApproaches", "Eye 04 — Ace Trainer / Veteran / Ranger", "Trainer-notice cue shared by Ace Trainers, Veterans and Pokémon Rangers. It plays before the battle theme begins.", track("EYE_04")),
  entry("trainerApproaches", "Eye 05 — Roughneck / Dancer / Guitarist", "Trainer-notice cue used by Roughnecks, Dancers, Guitarists and related street-trainer classes. It plays before the battle theme begins.", track("EYE_05")),
  entry("trainerApproaches", "Eye 06 — female trainer group", "Trainer-notice cue used by female Pokémon Breeders and Swimmers, Nursery Aides, female Clerks and Parasol Ladies. It plays before the battle theme begins.", track("EYE_06")),
  entry("trainerApproaches", "Eye 07 — Cyclist / male Swimmer", "Trainer-notice cue used by Cyclists and male Swimmers. It plays before the battle theme begins.", track("EYE_07")),
  entry("trainerApproaches", "Eye 08 — Black Belt / Battle Girl / Psychic", "Trainer-notice cue used by Black Belts, Battle Girls, Psychics and Bikers. It plays before the battle theme begins.", track("EYE_08")),
  entry("trainerApproaches", "Eye 09 — Scientist", "Trainer-notice cue used by Scientists. It plays before the battle theme begins.", track("EYE_09")),
  entry("trainerApproaches", "Eye 10 — Musician / Harlequin / Pokémon Fan", "Trainer-notice cue used by Musicians, standard Harlequins and Pokémon Fans. It plays before the battle theme begins.", track("EYE_10")),
  entry("trainerApproaches", "Eye 11 — Backpacker / Fisherman / sports", "Trainer-notice cue used by Backpackers, Fishermen, Hikers and several sports-player classes. It plays before the battle theme begins.", track("EYE_11")),
  entry("trainerApproaches", "Eye 12 — Worker / professional", "Trainer-notice cue used by Workers, Pilots, Clerks, Janitors, Doctors, Nurses, Police Officers and restaurant staff. It plays before the battle theme begins.", track("EYE_12")),
  entry("trainerApproaches", "Eye 13 — Gentleman / Socialite / Artist", "Trainer-notice cue used by Gentlemen, Socialites, Artists and Maids. It plays before the battle theme begins.", track("EYE_13")),
  entry("trainerApproaches", "Neo Team Plasma", "Trainer-notice cue used by Neo Team Plasma Grunts. Their battle theme is a separate sequence.", track("EYE_NEO_PLASMA")),
  entry("trainerApproaches", "Dancer variant", "Special BW2 trainer-notice cue assigned to the Adult Woman trainer class. It is separate from the standard Dancer class's Eye 05 cue.", track("EYE_DANCER")),
  entry("trainerApproaches", "Harlequin variant", "Special BW2 trainer-notice cue assigned to a separate Harlequin trainer class. It is separate from the standard Harlequin class's Eye 10 cue.", track("EYE_CLOWN")),
