...
('U01','Cold boot White2Upgrade-Following-0.7.15-alpha.nds with an ordinary matching save. Walk, run, reverse and stop.','Exactly one follower appears; no startup freeze, stuck input or duplicated actor.'),
...
text='''# White2Upgrade follower 0.7.15-alpha — human emulator checklist
